 ...
 * l'expiration : ce n'est pas son rôle. Le backend reste la seule source
 * de vérité de sécurité — un champ mal décodé ici ne peut jamais élargir
 * un accès, seulement masquer ou afficher un bouton qu'un appel API
 * refuserait ou accepterait de toute façon selon le vrai jeton vérifié
 * côté serveur.
 */
