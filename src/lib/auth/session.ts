 ...
 * darmeuble-kit/docs/frontend/architecture.md §"Le proxy" pour la raison :
 * il est posé directement par le backend en `Set-Cookie`, ce frontend le
 * relaie sans le lire ni le reconstruire.
 */
