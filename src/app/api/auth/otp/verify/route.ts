// Parcours locataire — téléphone + OTP SMS
// (darmeuble-kit/docs/backend/socle-backend.md §5). Même traitement que
// login/route.ts : Route Handler dédié, pas le proxy générique, pour poser
// le cookie d'accès et relayer le refresh.
